...
<asp:FormView ID="FormView1" runat="server" DataKeyNames="ID" DataSourceID="DetailCourseEntityDataSource">
    <ItemTemplate>
        <div class="course_box">
            ...
            <asp:Label ID="Label3" runat="server" Text='<%# "Category: " + Eval("Category") %>' />
...
<asp:EntityDataSource ID="DetailCourseEntityDataSource" runat="server" ConnectionString="name=QLKhoaHocEntities" DefaultContainerName="QLKhoaHocEntities" EnableFlattening="False" EntitySetName="Courses" Where="it.ID=@CourseID">
    <WhereParameters>
